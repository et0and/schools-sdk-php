 ...
 * Example usage:
 * ```
 * $params = (new SchoolByCityParams); // set properties as needed
 * $client->schools->byCity(...$params->toArray());
 * ```
 * Get schools by city.
 *
 * @method toArray()
 ...
 *
 * @phpstan-type school_by_city_params = array{limit?: int, page?: int}
 */
final class SchoolByCityParams implements BaseModel
{
    /** @use SdkModel<school_by_city_params> */
    use SdkModel;
    use SdkParams;
